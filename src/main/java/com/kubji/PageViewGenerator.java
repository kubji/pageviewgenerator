...
public class PageViewGenerator {
    ...
    int[] hourly_weight = new int[]{4, 3, 1, 1, 1, 1, 2, 2, 2, 2, 2, 2, 3, 3, 2, 2, 3, 13, 10, 8, 12, 12, 12, 10}; // Local time relative usage - consumer oriented website so peaks in evening
    ...
    HashMap<String,String> ipCountryCode = new HashMap<String, String>();
